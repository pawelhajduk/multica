...
VALUES ($1, $2, $3)
RETURNING id, name, email, avatar_url, created_at, updated_at, onboarded_at, onboarding_questionnaire, cloud_waitlist_email, cloud_waitlist_reason, starter_content_state, language, profile_description, timezone, visual_execution_history
`
...
func (q *Queries) CreateUser(ctx context.Context, arg CreateUserParams) (User, error) {
	...
	err := row.Scan(
		...
		&i.Timezone,
		&i.VisualExecutionHistory,
	)
	return i, err
}

const getUser = `-- name: GetUser :one
SELECT id, name, email, avatar_url, created_at, updated_at, onboarded_at, onboarding_questionnaire, cloud_waitlist_email, cloud_waitlist_reason, starter_content_state, language, profile_description, timezone, visual_execution_history FROM "user"
WHERE id = $1
`
...
UPDATE "user" SET
    ...
    visual_execution_history = COALESCE($7, visual_execution_history),
    updated_at = now()
WHERE id = $1
RETURNING id, name, email, avatar_url, created_at, updated_at, onboarded_at, onboarding_questionnaire, cloud_waitlist_email, cloud_waitlist_reason, starter_content_state, language, profile_description, timezone, visual_execution_history
`
...
type UpdateUserParams struct {
	...
	VisualExecutionHistory pgtype.Bool `json:"visual_execution_history"`
}
