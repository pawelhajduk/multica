 ...
 * just drops it in.
 *
 * Data modes (when not delegated via `onOpen`):
 *  - Visual: per-user opt-in (Settings → Preferences). Opens the chat-style
 *    read-only run view, which fetches its own timeline via `taskMessagesOptions`.
